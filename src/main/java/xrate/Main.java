...
public class Main {
    ...
    /**
     * Prompts the user for a currency code, and prints out the
     * exchange rate for that currency code for the (fixed)
     * date 25 June 2010 as read from the cached data.
     * 
     * @param args these are ignored
     * @throws IOException if there are problems reading the exchange
     * rate data from the URL
     */
